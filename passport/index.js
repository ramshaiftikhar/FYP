...
/* Key Point - When you log in, passport will put the user object (email and password and whatever else you’re saving — email, etc) into req.session.passport.user with the serializeUser() method. Then on future requests, you don’t need to ask the user to log in again for the life of the session.
