            ...
            <div className="container">
              ...
              <div className="row text-center">
                ...
                <div className="col-md-6">
                  ...
                  <p className="section-subheading">Data collected  is clustered  into different categories like education, food, clothes etc.</p>
                </div>
                ...
                <div className="col-md-6">
                  ...
                  <p className="section-subheading"> Only genuine applications are posted on the website after screening.</p>
                </div>
