   ...
   <MDBCol md='12'>
        <MDBCard wide cascade>
          ...
          <MDBCardBody cascade className='text-center'>
            ...
            <p className=" card-text pb-2"><strong>Phone no.: </strong>{props.phone} </p>
            <p className="card-text pb-2"><strong>Amount.: </strong> Rs. {props.amount}</p>
            ...
            <MDBCol md='12' className='d-flex justify-content-center'>
              <a href='!#' className='px-2 fa-lg li-ic'>
                <MDBIcon style={{color:'green'}}fa icon='edit'></MDBIcon>
              </a>

              <a href='!#' className='px-2 fa-lg tw-ic'>
                <MDBIcon  style={{color:'red'}} fa icon='trash'></MDBIcon>
              </a>
              </MDBCol>
              <MDBCol md='12' className='d-flex justify-content-center'>

              <p className=" creation  text-center mt-4">Created at: {new Date(props.dateString).toLocaleString()} </p>
            </MDBCol>
          </MDBCardBody>
        </MDBCard>
      </MDBCol>
